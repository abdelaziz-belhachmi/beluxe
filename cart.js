...
if (color || size) {
      ...
      console.log("yes at least one of us exist ");
...
document.getElementById("addtocart").innerHTML=`<button type="button" style="font-size: 20px;" disabled class="btn-dark bg-dark col-12"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-cart-check mb-1 mr-1" viewbox="0 0 18 18">
