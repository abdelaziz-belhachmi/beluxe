...
<input class="form-control sear mbr-fonts-style " type="search" placeholder="Search In Brands" aria-label="Search">
<div class="p-1"></div>
...
<div class="container-fluid d-flex justify-content-end " style="background-color: #A9A9A9;">

<div class="float-right">
<a class="nav-link text-dark mbr-fonts-style " href="MyCart.html"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bag" viewbox="0 0 16 16">
<path fill-rule="evenodd" d="M8 1a2.5 2.5 0 0 0-2.5 2.5V4h5v-.5A2.5 2.5 0 0 0 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5zM2 5v9a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V5H2z" />
</svg> &nbsp;Cart <span class="badge badge-dark" id="shpncrt">0</span></a>
</div>
<div class="float-right">
<a class="nav-link mbr-fonts-style text-dark " href="Support.html">
 ...
 <div class="container rounded bg-white mt-5 mb-5">
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"><span class="font-weight-bold">Account</span><span class="text-black-50"><?php echo $user_data['user_name']; ?></span><span> </span></div>
        </div>
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="mt-5 text-center"><a class="btn btn-danger" href="logout.php">Log out</a></div>

            </div>
        </div>
        <div class="col-md-4">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center experience"><span>Add Payment Method</span><span class="border px-3 p-1 add-experience"><i class="fa fa-plus"></i>&nbsp;ADD</span></div><br>
                <div class="col-md-12"><label class="labels">Email of the Recieving Account</label><input type="text" class="form-control" placeholder="Email" value=""></div> <br>
...
<footer class="bg-dark container-fluid">
  ...
  <div>
      <ul class="no-bullets site-footer__linklist">
          ...
          <li><a href="mailto:support@beluxe.today">Contact Us</a></li>
  </ul>
  </div>
  </div>
  ...
  <div class="ml-5 pl-5 d-flex justify-content-start align-items-center">
      <a href="https://www.facebook.com/Beluxe.today">
        <h4 class="p-4"><i class=" clas fa fa-facebook-official" aria-hidden="true"></i></h4>
      </a>
      <a href="https://www.instagram.com/beluxe.today">
