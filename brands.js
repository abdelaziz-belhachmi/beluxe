...
const brands ="https://raw.githubusercontent.com/abdelaziz-belhachmi/Jsontesting/main/brands";
...
function generateBoth(bmen,bwomen) {
    ...
    document.getElementById('fltr').innerText=`Filtre ${bn} Products`;
...
function generateCarousel(pictures) {
  ...
  //document.getElementById("indexx").innerHTML= `${pictures.map(function(elm) {document.getElementById("indexx").innerHTML=`<li data-target="#carouselExampleIndicators" data-slide-to="${indexOf(elm)}"></li>`;})}`;
...
<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewbox="0 0 24 24" width="24px" fill="#000000"><g><path d="M0,0h24v24H0V0z" fill="none"/></g><g><polygon points="6.23,20.23 8,22 18,12 8,2 6.23,3.77 14.46,12"/></g></svg>
  ...
  <div class="card">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="card-body">
      <b>**Important: Due to the impact of COVID-19 on fulfillment and shipping infrastructure, order delivery could be delayed up to an additional 3 business days for U.S. customers and an additional 21 business days for international customers**</b><br><br>

      Beluxe will cover the cost for Standard International Mail* (orders over $350+). Not all countries are eligible for free international shipping. Upgraded shipping options (estimated transit times and rates) will be quoted during checkout. 
      <br><br>
      ...
      <br><br>
      Once items are shipped, liability is covered by the terms of the carrier. We will ship to the address specified by the customer. If you did not provide us with an accurate address, neither beluxe, nor the shipping carrier can be held responsible for the loss of an item. Please double check your shipping address. Any shipping damage must be reported to beluxe within 48 hours of delivery, otherwise it is ineligible for any insurance or refund claims.
...
<!--generated-->`;
    ...
    // document.getElementById('colors').innerHTML =`${tof.map((color) =>{ return `<img src="${color}" alt="..." style="width: 100px;" class="img-thumbnail mr-2">`;}).join('')}`;
...
/*
        ...
        <button type="button" style="height: 40px;width: 40px;margin-right: 8px;margin-top: 5px;margin-bottom: 5px;" onclick="" class="btn btn-outline-dark p-2">XS</button>
        <button type="button" style="height: 40px;width: 40px;margin-right: 8px;margin-top: 5px;margin-bottom: 5px;" onclick="" class="btn btn-outline-dark p-2">S</button>
        <button type="button" style="height: 40px;width: 40px;margin-right: 8px;margin-top: 5px;margin-bottom: 5px;" onclick="" class="btn btn-outline-dark p-2">M</button>
        <button type="button" style="height: 40px;width: 40px;margin-right: 8px;margin-top: 5px;margin-bottom: 5px;" onclick="" class="btn btn-outline-dark p-2">L</button>
        <button type="button" style="height: 40px;width: 40px;margin-right: 8px;margin-top: 5px;margin-bottom: 5px;" onclick="" class="btn btn-outline-dark p-2">XL</button>
        <button type="button" style="height: 40px;width: 40px;margin-right: 8px;margin-top: 5px;margin-bottom: 5px;" onclick="" class="btn btn-outline-dark p-2">XXL</button>
